    ...
    layui.use(['table', 'element', 'jquery'], function () {
        ...
        var dataTable = table.render({
            ...
            , cols: [[ //表头
                ...
                , {
                    field: 'ifStatus', title: '是否收费', align: 'center', templet: function (data) {
        ...
        table.on("toolbar(table)", function (obj) {
            ...
            switch (event) {
                case "add":
                    window.location.href = '/admin/issue/addWit';
                    break;
                case 'search':
                    var title = $("#title").val();
        ...
        table.on("tool(table)", function (obj) {
            ...
            switch (event) {
                case "del":
                    ...
                    break;
                case "view":
                    window.location.href = '/admin/issue/section?id=' + data.id;
                    break;
            }
        })
